...
public class MP3PlayerGUI extends javax.swing.JDialog 
{
    ...
    private void initComponents() {
        ...
        getContentPane().add(Display, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 2, 350, 30));

        LoopCounter.setForeground(new java.awt.Color(51, 51, 255));
        getContentPane().add(LoopCounter, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 110, 70, -1));
    ...
    private void SelectFileMouseReleased(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_SelectFileMouseReleased
        ...
        chooser = new JFileChooser("G:\\Songs\\audio playlist");
